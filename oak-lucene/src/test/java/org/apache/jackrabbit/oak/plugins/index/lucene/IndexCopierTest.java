...
public class IndexCopierTest {
    ...
    public void basicTest() throws Exception{
        ...
        IndexCopier c1 = new RAMIndexCopier(baseDir, directExecutor(), getWorkDir());
    ...
    public void basicTestWithPrefetch() throws Exception{
        ...
        LuceneIndexDefinition defn = new LuceneIndexDefinition(root, builder.getNodeState(), "/foo");
        IndexCopier c1 = new RAMIndexCopier(baseDir, directExecutor(), getWorkDir(), true);
    ...
    public void basicTestWithFS() throws Exception{
        LuceneIndexDefinition defn = new LuceneIndexDefinition(root, builder.getNodeState(), "/foo");
        IndexCopier c1 = new IndexCopier(directExecutor(), getWorkDir());
    ...
    public void deleteCorruptedFile() throws Exception{
        Directory baseDir = new RAMDirectory();
        LuceneIndexDefinition defn = new LuceneIndexDefinition(root, builder.getNodeState(), "/foo");
        RAMIndexCopier c1 = new RAMIndexCopier(baseDir, directExecutor(), getWorkDir());
    ...
    public void deletedOnlyFilesForOlderVersion() throws Exception{
        ...
        LuceneIndexDefinition defn = new LuceneIndexDefinition(root, builder.getNodeState(), "/foo");
        IndexCopier copier = new RAMIndexCopier(baseDir, directExecutor(), getWorkDir());
    ...
    public void wrapForWriteWithoutIndexPath() throws Exception{
        ...
        IndexCopier copier = new IndexCopier(directExecutor(), getWorkDir());
    ...
    public void directoryContentMismatch_COR() throws Exception{
        Directory baseDir = new CloseSafeDir();
        LuceneIndexDefinition defn = new LuceneIndexDefinition(root, builder.getNodeState(), "/foo");
        IndexCopier copier = new RAMIndexCopier(baseDir, directExecutor(), getWorkDir(), true);
        ...
        //3. Reopen the copier
        copier = new RAMIndexCopier(baseDir, directExecutor(), getWorkDir(), true);
